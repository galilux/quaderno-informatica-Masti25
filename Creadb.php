...
<form method="post">
    <button type="submit" name="tutto">Tutti i DB</button>
    <button type="submit" name="atletica">DB atletica</button>
    <button type="submit" name="banca">DB banca</button>
    <button type="submit" name="marittima">DB marittimo</button>
    <button type="submit" name="multe">DB Multe</button>
    <button type="submit" name="treni">DB Treni</button>
    <button type="submit" name="vendite">DB Vendite</button>
    <button type="submit" name="fossili">DB Fossili</button>
    <button type="submit" name="wordpress">DB Wordpress</button>
    <button type="submit" name="joomla">DB Joomla</button>
</form>
<?php
...
--
-- Host: 127.0.0.1
-- Creato il: Mag 14, 2025 alle 00:49
-- Versione del server: 10.4.32-MariaDB
-- Versione PHP: 8.2.12
...
--
-- Database: `202425_5ia_abdelhamid_joomla`
--
create database IF NOT EXISTS `202425_5ia_abdelhamid_joomla`;
USE `202425_5ia_abdelhamid_joomla`;
-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_action_logs`
--

CREATE TABLE `govhc_action_logs` (
...
--
-- Dump dei dati per la tabella `govhc_action_logs`
--

INSERT INTO `govhc_action_logs` (`id`, `message_language_key`, `message`, `log_date`, `extension`, `user_id`, `item_id`, `ip_address`) VALUES
(1, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":871,\"username\":\"Masti\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=871\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE\"}', '2025-05-13 21:08:34', 'com_users', 871, 0, 'COM_ACTIONLOGS_DISABLED');

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_action_logs_extensions`
--

CREATE TABLE `govhc_action_logs_extensions` (
  `id` int(10) UNSIGNED NOT NULL,
  `extension` varchar(255) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dump dei dati per la tabella `govhc_action_logs_extensions`
--

INSERT INTO `govhc_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Struttura della tabella `govhc_action_logs_users`
--

CREATE TABLE `govhc_action_logs_users` (
...
--
-- Struttura della tabella `govhc_action_log_config`
--

CREATE TABLE `govhc_action_log_config` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dump dei dati per la tabella `govhc_action_log_config`
--

INSERT INTO `govhc_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Struttura della tabella `govhc_assets`
--

CREATE TABLE `govhc_assets` (
...
--
-- Dump dei dati per la tabella `govhc_assets`
--

INSERT INTO `govhc_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Struttura della tabella `govhc_associations`
--

CREATE TABLE `govhc_associations` (
...
--
-- Struttura della tabella `govhc_banners`
--

CREATE TABLE `govhc_banners` (
  `id` int(11) NOT NULL,
...
--
-- Struttura della tabella `govhc_banner_clients`
--

CREATE TABLE `govhc_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Struttura della tabella `govhc_banner_tracks`
--

CREATE TABLE `govhc_banner_tracks` (
...
--
-- Struttura della tabella `govhc_categories`
--

CREATE TABLE `govhc_categories` (
  `id` int(11) NOT NULL,
...
--
-- Dump dei dati per la tabella `govhc_categories`
--

INSERT INTO `govhc_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, NULL, NULL, 1, '{}', '', '', '{}', 871, '2025-05-13 21:06:52', 871, '2025-05-13 21:06:52', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\",\"workflow_id\":\"use_default\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 871, '2025-05-13 21:06:52', 871, '2025-05-13 21:06:52', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 871, '2025-05-13 21:06:52', 871, '2025-05-13 21:06:52', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 871, '2025-05-13 21:06:52', 871, '2025-05-13 21:06:52', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 871, '2025-05-13 21:06:52', 871, '2025-05-13 21:06:52', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 871, '2025-05-13 21:06:52', 871, '2025-05-13 21:06:52', 0, '*', 1);

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_contact_details`
--

CREATE TABLE `govhc_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Struttura della tabella `govhc_content`
--

CREATE TABLE `govhc_content` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
  `title` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Struttura della tabella `govhc_contentitem_tag_map`
--

CREATE TABLE `govhc_contentitem_tag_map` (
  `type_alias` varchar(255) NOT NULL DEFAULT '',
...
--
-- Struttura della tabella `govhc_content_frontpage`
--

CREATE TABLE `govhc_content_frontpage` (
...
--
-- Struttura della tabella `govhc_content_rating`
--

CREATE TABLE `govhc_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Struttura della tabella `govhc_content_types`
--

CREATE TABLE `govhc_content_types` (
...
--
-- Dump dei dati per la tabella `govhc_content_types`
--

INSERT INTO `govhc_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Struttura della tabella `govhc_extensions`
--

CREATE TABLE `govhc_extensions` (
...
--
-- Dump dei dati per la tabella `govhc_extensions`
--

INSERT INTO `govhc_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `changelogurl`, `folder`, `client_id`, `enabled`, `access`, `protected`, `locked`, `manifest_cache`, `params`, `custom_data`, `checked_out`, `checked_out_time`, `ordering`, `state`, `note`) VALUES
...
--
-- Struttura della tabella `govhc_fields`
--

CREATE TABLE `govhc_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Struttura della tabella `govhc_fields_categories`
--

CREATE TABLE `govhc_fields_categories` (
...
--
-- Struttura della tabella `govhc_fields_groups`
--

CREATE TABLE `govhc_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `context` varchar(255) NOT NULL DEFAULT '',
  `title` varchar(255) NOT NULL DEFAULT '',
...
--
-- Struttura della tabella `govhc_fields_values`
--

CREATE TABLE `govhc_fields_values` (
...
--
-- Struttura della tabella `govhc_finder_filters`
--

CREATE TABLE `govhc_finder_filters` (
...
--
-- Struttura della tabella `govhc_finder_links`
--

CREATE TABLE `govhc_finder_links` (
...
--
-- Struttura della tabella `govhc_finder_links_terms`
--

CREATE TABLE `govhc_finder_links_terms` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Struttura della tabella `govhc_finder_logging`
--

CREATE TABLE `govhc_finder_logging` (
...
--
-- Struttura della tabella `govhc_finder_taxonomy`
--

CREATE TABLE `govhc_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `lft` int(11) NOT NULL DEFAULT 0,
  `rgt` int(11) NOT NULL DEFAULT 0,
...
--
-- Dump dei dati per la tabella `govhc_finder_taxonomy`
--

INSERT INTO `govhc_finder_taxonomy` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `state`, `access`, `language`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', 1, 1, '*');

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_finder_taxonomy_map`
--

CREATE TABLE `govhc_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Struttura della tabella `govhc_finder_terms`
--

CREATE TABLE `govhc_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Struttura della tabella `govhc_finder_terms_common`
--

CREATE TABLE `govhc_finder_terms_common` (
...
--
-- Dump dei dati per la tabella `govhc_finder_terms_common`
--

INSERT INTO `govhc_finder_terms_common` (`term`, `language`, `custom`) VALUES
('a', 'en', 0),
('about', 'en', 0),
('above', 'en', 0),
('after', 'en', 0),
...
--
-- Struttura della tabella `govhc_finder_tokens`
--

CREATE TABLE `govhc_finder_tokens` (
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `stem` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `common` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
  `phrase` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Struttura della tabella `govhc_finder_tokens_aggregate`
--

CREATE TABLE `govhc_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `stem` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `common` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Struttura della tabella `govhc_finder_types`
--

CREATE TABLE `govhc_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Struttura della tabella `govhc_guidedtours`
--

CREATE TABLE `govhc_guidedtours` (
  `id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dump dei dati per la tabella `govhc_guidedtours`
--

INSERT INTO `govhc_guidedtours` (`id`, `title`, `uid`, `description`, `ordering`, `extensions`, `url`, `created`, `created_by`, `modified`, `modified_by`, `checked_out_time`, `checked_out`, `published`, `language`, `note`, `access`, `autostart`) VALUES
(1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_TITLE', 'joomla-guidedtours', 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_DESCRIPTION', 1, '[\"com_guidedtours\"]', 'administrator/index.php?option=com_guidedtours&view=tours', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, 1, '*', '', 1, 0),
(2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_TITLE', 'joomla-guidedtoursteps', 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_DESCRIPTION', 2, '[\"com_guidedtours\"]', 'administrator/index.php?option=com_guidedtours&view=tours', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, 1, '*', '', 1, 0),
(3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_TITLE', 'joomla-articles', 'COM_GUIDEDTOURS_TOUR_ARTICLES_DESCRIPTION', 3, '[\"com_content\",\"com_categories\"]', 'administrator/index.php?option=com_content&view=articles', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, 1, '*', '', 1, 0),
(4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_TITLE', 'joomla-categories', 'COM_GUIDEDTOURS_TOUR_CATEGORIES_DESCRIPTION', 4, '[\"com_content\",\"com_categories\"]', 'administrator/index.php?option=com_categories&view=categories&extension=com_content', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, 1, '*', '', 1, 0),
(5, 'COM_GUIDEDTOURS_TOUR_MENUS_TITLE', 'joomla-menus', 'COM_GUIDEDTOURS_TOUR_MENUS_DESCRIPTION', 5, '[\"com_menus\"]', 'administrator/index.php?option=com_menus&view=menus', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, 1, '*', '', 1, 0),
(6, 'COM_GUIDEDTOURS_TOUR_TAGS_TITLE', 'joomla-tags', 'COM_GUIDEDTOURS_TOUR_TAGS_DESCRIPTION', 6, '[\"com_tags\"]', 'administrator/index.php?option=com_tags&view=tags', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, 1, '*', '', 1, 0),
(7, 'COM_GUIDEDTOURS_TOUR_BANNERS_TITLE', 'joomla-banners', 'COM_GUIDEDTOURS_TOUR_BANNERS_DESCRIPTION', 7, '[\"com_banners\"]', 'administrator/index.php?option=com_banners&view=banners', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, 1, '*', '', 1, 0),
(8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_TITLE', 'joomla-contacts', 'COM_GUIDEDTOURS_TOUR_CONTACTS_DESCRIPTION', 8, '[\"com_contact\"]', 'administrator/index.php?option=com_contact&view=contacts', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, 1, '*', '', 1, 0),
(9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_TITLE', 'joomla-newsfeeds', 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_DESCRIPTION', 9, '[\"com_newsfeeds\"]', 'administrator/index.php?option=com_newsfeeds&view=newsfeeds', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, 1, '*', '', 1, 0),
(10, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_TITLE', 'joomla-smartsearch', 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_DESCRIPTION', 10, '[\"com_finder\"]', 'administrator/index.php?option=com_finder&view=filters', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, 1, '*', '', 1, 0),
(11, 'COM_GUIDEDTOURS_TOUR_USERS_TITLE', 'joomla-users', 'COM_GUIDEDTOURS_TOUR_USERS_DESCRIPTION', 11, '[\"com_users\"]', 'administrator/index.php?option=com_users&view=users', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, 1, '*', '', 1, 0),
(12, 'COM_GUIDEDTOURS_TOUR_WELCOMETOJOOMLA_TITLE', 'joomla-welcome', 'COM_GUIDEDTOURS_TOUR_WELCOMETOJOOMLA_DESCRIPTION', 12, '[\"com_cpanel\"]', 'administrator/index.php', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, 1, '*', '', 1, 1);

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_guidedtour_steps`
--

CREATE TABLE `govhc_guidedtour_steps` (
  `id` int(11) NOT NULL,
...
--
-- Dump dei dati per la tabella `govhc_guidedtour_steps`
--

INSERT INTO `govhc_guidedtour_steps` (`id`, `tour_id`, `title`, `published`, `description`, `ordering`, `position`, `target`, `type`, `interactive_type`, `url`, `created`, `created_by`, `modified`, `modified_by`, `checked_out_time`, `checked_out`, `language`, `note`, `params`) VALUES
(1, 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_NEW_DESCRIPTION', 1, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_guidedtours&view=tours', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(2, 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_TITLE_DESCRIPTION', 2, 'bottom', '#jform_title', 2, 2, 'administrator/index.php?option=com_guidedtours&view=tour&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(3, 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_URL_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_URL_DESCRIPTION', 3, 'top', '#jform_url', 2, 2, 'administrator/index.php?option=com_guidedtours&view=tour&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(4, 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_CONTENT_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_CONTENT_DESCRIPTION', 4, 'bottom', '#jform_description,#jform_description_ifr', 2, 3, 'administrator/index.php?option=com_guidedtours&view=tour&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(5, 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_COMPONENT_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_COMPONENT_DESCRIPTION', 5, 'top', 'joomla-field-fancy-select .choices', 2, 3, 'administrator/index.php?option=com_guidedtours&view=tour&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(6, 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_AUTOSTART_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_AUTOSTART_DESCRIPTION', 6, 'bottom', '#jform_autostart0', 2, 3, '', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(7, 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_SAVECLOSE_DESCRIPTION', 7, 'top', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_guidedtours&view=tour&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(8, 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_CONGRATULATIONS_DESCRIPTION', 8, 'bottom', '', 0, 1, 'administrator/index.php?option=com_guidedtours&view=tour&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(9, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_COUNTER_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_COUNTER_DESCRIPTION', 9, 'top', '#toursList tbody tr:nth-last-of-type(1) td:nth-of-type(5) .btn', 2, 1, '', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(10, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_NEW_DESCRIPTION', 10, 'bottom', '.button-new', 2, 1, '', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(11, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_TITLE_DESCRIPTION', 11, 'bottom', '#jform_title', 2, 2, '', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(12, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_DESCRIPTION_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_DESCRIPTION_DESCRIPTION', 12, 'bottom', '#jform_description,#jform_description_ifr', 2, 3, '', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(13, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_STATUS_DESCRIPTION', 13, 'bottom', '#jform_published', 2, 3, '', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(14, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_POSITION_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_POSITION_DESCRIPTION', 14, 'top', '#jform_position', 2, 3, '', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(15, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_TARGET_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_TARGET_DESCRIPTION', 15, 'top', '#jform_target', 2, 3, '', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(16, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_TYPE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_TYPE_DESCRIPTION', 16, 'top', '#jform_type', 2, 3, '', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(17, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_SAVECLOSE_DESCRIPTION', 17, 'bottom', '#save-group-children-save .button-save', 2, 1, '', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(18, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_CONGRATULATIONS_DESCRIPTION', 18, 'bottom', '', 0, 1, '', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(19, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_NEW_DESCRIPTION', 19, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_content&view=articles', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(20, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_TITLE_DESCRIPTION', 20, 'bottom', '#jform_title', 2, 2, 'administrator/index.php?option=com_content&view=article&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(21, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_ALIAS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_ALIAS_DESCRIPTION', 21, 'bottom', '#jform_alias', 2, 2, 'administrator/index.php?option=com_content&view=article&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(22, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_CONTENT_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_CONTENT_DESCRIPTION', 22, 'bottom', '#jform_articletext,#jform_articletext_ifr', 2, 3, 'administrator/index.php?option=com_content&view=article&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(23, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_STATUS_DESCRIPTION', 23, 'bottom', '#jform_state', 2, 3, 'administrator/index.php?option=com_content&view=article&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(24, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_CATEGORY_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_CATEGORY_DESCRIPTION', 24, 'top', 'joomla-field-fancy-select .choices[data-type=select-one]', 2, 3, 'administrator/index.php?option=com_content&view=article&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(25, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_FEATURED_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_FEATURED_DESCRIPTION', 25, 'bottom', '#jform_featured0', 2, 3, 'administrator/index.php?option=com_content&view=article&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(26, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_ACCESS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_ACCESS_DESCRIPTION', 26, 'bottom', '#jform_access', 2, 3, 'administrator/index.php?option=com_content&view=article&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(27, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_TAGS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_TAGS_DESCRIPTION', 27, 'top', 'joomla-field-fancy-select .choices[data-type=select-multiple]', 2, 3, 'administrator/index.php?option=com_content&view=article&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(28, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_NOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_NOTE_DESCRIPTION', 28, 'top', '#jform_note', 2, 2, 'administrator/index.php?option=com_content&view=article&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(29, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_VERSIONNOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_VERSIONNOTE_DESCRIPTION', 29, 'top', '#jform_version_note', 2, 2, 'administrator/index.php?option=com_content&view=article&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(30, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_SAVECLOSE_DESCRIPTION', 30, 'bottom', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_content&view=article&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(31, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_CONGRATULATIONS_DESCRIPTION', 31, 'bottom', '', 0, 1, 'administrator/index.php?option=com_content&view=article&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(32, 4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_NEW_DESCRIPTION', 32, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_categories&view=categories&extension=com_content', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(33, 4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_TITLE_DESCRIPTION', 33, 'bottom', '#jform_title', 2, 2, 'administrator/index.php?option=com_categories&view=category&layout=edit&extension=com_content', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(34, 4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_ALIAS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_ALIAS_DESCRIPTION', 34, 'bottom', '#jform_alias', 2, 2, 'administrator/index.php?option=com_categories&view=category&layout=edit&extension=com_content', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(35, 4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_CONTENT_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_CONTENT_DESCRIPTION', 35, 'bottom', '#jform_description,#jform_description_ifr', 2, 3, 'administrator/index.php?option=com_categories&view=category&layout=edit&extension=com_content', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
...
(37, 4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_STATUS_DESCRIPTION', 37, 'bottom', '#jform_published', 2, 3, 'administrator/index.php?option=com_categories&view=category&layout=edit&extension=com_content', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(38, 4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_ACCESS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_ACCESS_DESCRIPTION', 38, 'bottom', '#jform_access', 2, 3, 'administrator/index.php?option=com_categories&view=category&layout=edit&extension=com_content', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
...
(40, 4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_NOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_NOTE_DESCRIPTION', 40, 'top', '#jform_note', 2, 2, 'administrator/index.php?option=com_categories&view=category&layout=edit&extension=com_content', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
...
(44, 5, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_NEW_DESCRIPTION', 44, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_menus&view=menus', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(45, 5, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_TITLE_DESCRIPTION', 45, 'bottom', '#jform_title', 2, 2, 'administrator/index.php?option=com_menus&view=menu&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(46, 5, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_UNIQUENAME_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_UNIQUENAME_DESCRIPTION', 46, 'top', '#jform_menutype', 2, 2, 'administrator/index.php?option=com_menus&view=menu&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(47, 5, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_DESCRIPTION_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_DESCRIPTION_DESCRIPTION', 47, 'top', '#jform_menudescription', 2, 2, 'administrator/index.php?option=com_menus&view=menu&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(48, 5, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_SAVECLOSE_DESCRIPTION', 48, 'bottom', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_menus&view=menu&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(49, 5, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_CONGRATULATIONS_DESCRIPTION', 49, 'bottom', '', 0, 1, 'administrator/index.php?option=com_menus&view=menu&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(50, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_NEW_DESCRIPTION', 50, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_tags&view=tags', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(51, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_TITLE_DESCRIPTION', 51, 'bottom', '#jform_title', 2, 2, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(52, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_ALIAS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_ALIAS_DESCRIPTION', 52, 'bottom', '#jform_alias', 2, 2, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(53, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_CONTENT_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_CONTENT_DESCRIPTION', 53, 'bottom', '#jform_description,#jform_description_ifr', 2, 3, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(54, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_PARENT_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_PARENT_DESCRIPTION', 54, 'top', 'joomla-field-fancy-select .choices[data-type=select-one]', 2, 3, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(55, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_STATUS_DESCRIPTION', 55, 'bottom', '#jform_published', 2, 3, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(56, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_ACCESS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_ACCESS_DESCRIPTION', 56, 'bottom', '#jform_access', 2, 3, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(57, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_NOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_NOTE_DESCRIPTION', 57, 'top', '#jform_note', 2, 2, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(58, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_VERSIONNOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_VERSIONNOTE_DESCRIPTION', 58, 'top', '#jform_version_note', 2, 2, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(59, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_SAVECLOSE_DESCRIPTION', 59, 'bottom', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(60, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_CONGRATULATIONS_DESCRIPTION', 60, 'bottom', '', 0, 1, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(61, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_NEW_DESCRIPTION', 61, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_banners&view=banners', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(62, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_TITLE_DESCRIPTION', 62, 'bottom', '#jform_name', 2, 2, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(63, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_ALIAS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_ALIAS_DESCRIPTION', 63, 'bottom', '#jform_alias', 2, 2, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(64, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_DETAILS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_DETAILS_DESCRIPTION', 64, 'bottom', '.col-lg-9', 2, 3, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(65, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_STATUS_DESCRIPTION', 65, 'bottom', '#jform_state', 2, 3, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(66, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_CATEGORY_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_CATEGORY_DESCRIPTION', 66, 'top', 'joomla-field-fancy-select .choices[data-type=select-one]', 2, 3, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(67, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_PINNED_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_PINNED_DESCRIPTION', 67, 'bottom', '#jform_sticky1', 2, 3, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(68, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_VERSIONNOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_VERSIONNOTE_DESCRIPTION', 68, 'top', '#jform_version_note', 2, 2, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(69, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_SAVECLOSE_DESCRIPTION', 69, 'bottom', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(70, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_CONGRATULATIONS_DESCRIPTION', 70, 'bottom', '', 0, 1, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(71, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_NEW_DESCRIPTION', 71, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_contact&view=contacts', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(72, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_TITLE_DESCRIPTION', 72, 'bottom', '#jform_name', 2, 2, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(73, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_ALIAS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_ALIAS_DESCRIPTION', 73, 'bottom', '#jform_alias', 2, 2, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(74, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_DETAILS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_DETAILS_DESCRIPTION', 74, 'bottom', '.col-lg-9', 0, 1, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(75, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_STATUS_DESCRIPTION', 75, 'bottom', '#jform_published', 2, 3, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(76, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_CATEGORY_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_CATEGORY_DESCRIPTION', 76, 'top', 'joomla-field-fancy-select .choices[data-type=select-one]', 2, 3, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(77, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_FEATURED_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_FEATURED_DESCRIPTION', 77, 'bottom', '#jform_featured0', 2, 3, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(78, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_ACCESS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_ACCESS_DESCRIPTION', 78, 'bottom', '#jform_access', 2, 3, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(79, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_TAGS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_TAGS_DESCRIPTION', 79, 'top', 'joomla-field-fancy-select .choices[data-type=select-multiple]', 2, 3, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(80, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_VERSIONNOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_VERSIONNOTE_DESCRIPTION', 80, 'top', '#jform_version_note', 2, 2, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(81, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_SAVECLOSE_DESCRIPTION', 81, 'bottom', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(82, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_CONGRATULATIONS_DESCRIPTION', 82, 'bottom', '', 0, 1, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(83, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_NEW_DESCRIPTION', 83, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_newsfeeds&view=newsfeeds', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(84, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_TITLE_DESCRIPTION', 84, 'bottom', '#jform_name', 2, 2, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(85, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_ALIAS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_ALIAS_DESCRIPTION', 85, 'bottom', '#jform_alias', 2, 2, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(86, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_LINK_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_LINK_DESCRIPTION', 86, 'bottom', '#jform_link', 2, 2, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(87, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_DESCRIPTION_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_DESCRIPTION_DESCRIPTION', 87, 'bottom', '#jform_description,#jform_description_ifr', 2, 3, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(88, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_STATUS_DESCRIPTION', 88, 'bottom', '#jform_published', 2, 3, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(89, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_CATEGORY_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_CATEGORY_DESCRIPTION', 89, 'top', 'joomla-field-fancy-select .choices[data-type=select-one]', 2, 3, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(90, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_ACCESS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_ACCESS_DESCRIPTION', 90, 'bottom', '#jform_access', 2, 3, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(91, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_TAGS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_TAGS_DESCRIPTION', 91, 'top', 'joomla-field-fancy-select .choices[data-type=select-multiple]', 2, 3, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(92, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_VERSIONNOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_VERSIONNOTE_DESCRIPTION', 92, 'top', '#jform_version_note', 2, 2, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(93, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_SAVECLOSE_DESCRIPTION', 93, 'bottom', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(94, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_CONGRATULATIONS_DESCRIPTION', 94, 'bottom', '', 0, 1, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(95, 10, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_NEW_DESCRIPTION', 95, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_finder&view=filters', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(96, 10, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_TITLE_DESCRIPTION', 96, 'bottom', '#jform_title', 2, 2, 'administrator/index.php?option=com_finder&view=filter&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(97, 10, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_ALIAS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_ALIAS_DESCRIPTION', 97, 'bottom', '#jform_alias', 2, 2, 'administrator/index.php?option=com_finder&view=filter&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(98, 10, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_CONTENT_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_CONTENT_DESCRIPTION', 98, 'bottom', '.col-lg-9', 0, 1, 'administrator/index.php?option=com_finder&view=filter&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(99, 10, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_STATUS_DESCRIPTION', 99, 'bottom', '#jform_state', 2, 3, 'administrator/index.php?option=com_finder&view=filter&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(100, 10, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_SAVECLOSE_DESCRIPTION', 100, 'bottom', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_finder&view=filter&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(101, 10, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_CONGRATULATIONS_DESCRIPTION', 101, 'bottom', '', 0, 1, 'administrator/index.php?option=com_finder&view=filter&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(102, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_NEW_DESCRIPTION', 102, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_users&view=user&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(103, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_NAME_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_NAME_DESCRIPTION', 103, 'bottom', '#jform_name', 2, 2, 'administrator/index.php?option=com_users&view=user&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(104, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_LOGINNAME_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_LOGINNAME_DESCRIPTION', 104, 'bottom', '#jform_username', 2, 2, 'administrator/index.php?option=com_users&view=user&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(105, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_PASSWORD_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_PASSWORD_DESCRIPTION', 105, 'bottom', '#jform_password', 2, 2, 'administrator/index.php?option=com_users&view=user&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(106, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_PASSWORD2_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_PASSWORD2_DESCRIPTION', 106, 'bottom', '#jform_password2', 2, 2, 'administrator/index.php?option=com_users&view=user&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(107, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_EMAIL_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_EMAIL_DESCRIPTION', 107, 'bottom', '#jform_email', 2, 2, 'administrator/index.php?option=com_users&view=user&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(108, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_SYSTEMEMAIL_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_SYSTEMEMAIL_DESCRIPTION', 108, 'top', '#jform_sendEmail0', 2, 3, 'administrator/index.php?option=com_users&view=user&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(109, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_STATUS_DESCRIPTION', 109, 'top', '#jform_block0', 2, 3, 'administrator/index.php?option=com_users&view=user&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(110, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_PASSWORDRESET_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_PASSWORDRESET_DESCRIPTION', 110, 'top', '#jform_requireReset0', 2, 3, 'administrator/index.php?option=com_users&view=user&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(111, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_SAVECLOSE_DESCRIPTION', 111, 'bottom', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_users&view=user&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(112, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_CONGRATULATIONS_DESCRIPTION', 112, 'bottom', '', 0, 1, 'administrator/index.php?option=com_users&view=user&layout=edit', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(113, 12, 'COM_GUIDEDTOURS_TOUR_WELCOMETOJOOMLA_STEP_MENUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_WELCOMETOJOOMLA_STEP_MENUS_DESCRIPTION', 113, 'right', '#sidebarmenu', 0, 1, '', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(114, 12, 'COM_GUIDEDTOURS_TOUR_WELCOMETOJOOMLA_STEP_QUICKACCESS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_WELCOMETOJOOMLA_STEP_QUICKACCESS_DESCRIPTION', 114, 'center', '', 0, 1, '', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(115, 12, 'COM_GUIDEDTOURS_TOUR_WELCOMETOJOOMLA_STEP_NOTIFICATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_WELCOMETOJOOMLA_STEP_NOTIFICATIONS_DESCRIPTION', 115, 'left', '.quickicons-for-update_quickicon .card', 0, 1, '', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(116, 12, 'COM_GUIDEDTOURS_TOUR_WELCOMETOJOOMLA_STEP_TOPBAR_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_WELCOMETOJOOMLA_STEP_TOPBAR_DESCRIPTION', 116, 'bottom', '#header', 0, 1, '', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL),
(117, 12, 'COM_GUIDEDTOURS_TOUR_WELCOMETOJOOMLA_STEP_FINALWORDS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_WELCOMETOJOOMLA_STEP_FINALWORDS_DESCRIPTION', 117, 'right', '#sidebarmenu nav > ul:first-of-type > li:last-child', 0, 1, '', '2025-05-13 21:06:53', 871, '2025-05-13 21:06:53', 871, NULL, NULL, '*', '', NULL);

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_history`
--

CREATE TABLE `govhc_history` (
...
--
-- Struttura della tabella `govhc_languages`
--

CREATE TABLE `govhc_languages` (
...
--
-- Dump dei dati per la tabella `govhc_languages`
--

INSERT INTO `govhc_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_mail_templates`
--

CREATE TABLE `govhc_mail_templates` (
...
--
-- Dump dei dati per la tabella `govhc_mail_templates`
--

INSERT INTO `govhc_mail_templates` (`template_id`, `extension`, `language`, `subject`, `body`, `htmlbody`, `attachments`, `params`) VALUES
...
--
-- Struttura della tabella `govhc_menu`
--

CREATE TABLE `govhc_menu` (
  `id` int(11) NOT NULL,
...
--
-- Dump dei dati per la tabella `govhc_menu`
--

INSERT INTO `govhc_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`) VALUES
...
--
-- Struttura della tabella `govhc_menu_types`
--

CREATE TABLE `govhc_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Dump dei dati per la tabella `govhc_menu_types`
--

INSERT INTO `govhc_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`, `ordering`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0, 1);

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_messages`
--

CREATE TABLE `govhc_messages` (
...
--
-- Struttura della tabella `govhc_messages_cfg`
--

CREATE TABLE `govhc_messages_cfg` (
...
--
-- Struttura della tabella `govhc_modules`
--

CREATE TABLE `govhc_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
...
--
-- Dump dei dati per la tabella `govhc_modules`
--

INSERT INTO `govhc_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Struttura della tabella `govhc_modules_menu`
--

CREATE TABLE `govhc_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT 0,
  `menuid` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dump dei dati per la tabella `govhc_modules_menu`
--

INSERT INTO `govhc_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Struttura della tabella `govhc_newsfeeds`
--

CREATE TABLE `govhc_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT 0,
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Struttura della tabella `govhc_overrider`
--

CREATE TABLE `govhc_overrider` (
...
--
-- Struttura della tabella `govhc_postinstall_messages`
--

CREATE TABLE `govhc_postinstall_messages` (
...
--
-- Dump dei dati per la tabella `govhc_postinstall_messages`
--

INSERT INTO `govhc_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Struttura della tabella `govhc_privacy_consents`
--

CREATE TABLE `govhc_privacy_consents` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `state` int(11) NOT NULL DEFAULT 1,
  `created` datetime NOT NULL,
...
--
-- Struttura della tabella `govhc_privacy_requests`
--

CREATE TABLE `govhc_privacy_requests` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Struttura della tabella `govhc_redirect_links`
--

CREATE TABLE `govhc_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Struttura della tabella `govhc_scheduler_logs`
--

CREATE TABLE `govhc_scheduler_logs` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Struttura della tabella `govhc_scheduler_tasks`
--

CREATE TABLE `govhc_scheduler_tasks` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
  `title` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dump dei dati per la tabella `govhc_scheduler_tasks`
--

INSERT INTO `govhc_scheduler_tasks` (`id`, `asset_id`, `title`, `type`, `execution_rules`, `cron_rules`, `state`, `last_exit_code`, `last_execution`, `next_execution`, `times_executed`, `times_failed`, `locked`, `priority`, `ordering`, `cli_exclusive`, `params`, `note`, `created`, `created_by`, `checked_out`, `checked_out_time`) VALUES
(1, 97, 'Rotate Logs', 'rotation.logs', '{\"rule-type\":\"interval-days\",\"interval-days\":\"30\",\"exec-day\":\"13\",\"exec-time\":\"21:00\"}', '{\"type\":\"interval\",\"exp\":\"P30D\"}', 1, 0, NULL, '2025-06-12 21:00:00', 0, 0, NULL, 0, 0, 0, '{\"individual_log\":false,\"log_file\":\"\",\"notifications\":{\"success_mail\":\"0\",\"failure_mail\":\"1\",\"fatal_failure_mail\":\"1\",\"orphan_mail\":\"1\"},\"logstokeep\":1}', NULL, '2025-05-13 21:06:53', 871, NULL, NULL),
(2, 98, 'Session GC', 'session.gc', '{\"rule-type\":\"interval-hours\",\"interval-hours\":\"24\",\"exec-day\":\"01\",\"exec-time\":\"21:00\"}', '{\"type\":\"interval\",\"exp\":\"PT24H\"}', 1, 0, NULL, '2025-05-14 21:00:00', 0, 0, NULL, 0, 0, 0, '{\"individual_log\":false,\"log_file\":\"\",\"notifications\":{\"success_mail\":\"0\",\"failure_mail\":\"1\",\"fatal_failure_mail\":\"1\",\"orphan_mail\":\"1\"},\"enable_session_gc\":1,\"enable_session_metadata_gc\":1}', NULL, '2025-05-13 21:06:53', 871, NULL, NULL),
(3, 99, 'Update Notification', 'update.notification', '{\"rule-type\":\"interval-hours\",\"interval-hours\":\"24\",\"exec-day\":\"01\",\"exec-time\":\"21:00\"}', '{\"type\":\"interval\",\"exp\":\"PT24H\"}', 1, 0, NULL, '2025-05-14 21:00:00', 0, 0, NULL, 0, 0, 0, '{\"individual_log\":false,\"log_file\":\"\",\"notifications\":{\"success_mail\":\"0\",\"failure_mail\":\"1\",\"fatal_failure_mail\":\"1\",\"orphan_mail\":\"1\"},\"email\":\"\",\"language_override\":\"\"}', NULL, '2025-05-13 21:06:53', 871, NULL, NULL);

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_schemaorg`
--

CREATE TABLE `govhc_schemaorg` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Struttura della tabella `govhc_schemas`
--

CREATE TABLE `govhc_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dump dei dati per la tabella `govhc_schemas`
--

INSERT INTO `govhc_schemas` (`extension_id`, `version_id`) VALUES
(241, '5.3.0-2025-03-14');

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_session`
--

CREATE TABLE `govhc_session` (
...
--
-- Dump dei dati per la tabella `govhc_session`
--

INSERT INTO `govhc_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x30636e7468366a6535336c647639713933623136716f68396c66, NULL, 1, 1747176498, 'joomla|s:416:\"\";', 0, '');

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_tags`
--

CREATE TABLE `govhc_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `lft` int(11) NOT NULL DEFAULT 0,
  `rgt` int(11) NOT NULL DEFAULT 0,
...
--
-- Dump dei dati per la tabella `govhc_tags`
--

INSERT INTO `govhc_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, NULL, NULL, 1, '', '', '', '', 871, '2025-05-13 21:06:51', '', 871, '2025-05-13 21:06:51', '', '', 0, '*', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_template_overrides`
--

CREATE TABLE `govhc_template_overrides` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Struttura della tabella `govhc_template_styles`
--

CREATE TABLE `govhc_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
  `template` varchar(50) NOT NULL DEFAULT '',
  `client_id` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Dump dei dati per la tabella `govhc_template_styles`
--

INSERT INTO `govhc_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `inheritable`, `parent`, `params`) VALUES
...
--
-- Struttura della tabella `govhc_tuf_metadata`
--

CREATE TABLE `govhc_tuf_metadata` (
  `id` int(11) NOT NULL,
...
--
-- Dump dei dati per la tabella `govhc_tuf_metadata`
--

INSERT INTO `govhc_tuf_metadata` (`id`, `update_site_id`, `root`, `targets`, `snapshot`, `timestamp`, `mirrors`) VALUES
...
--
-- Struttura della tabella `govhc_ucm_base`
--

CREATE TABLE `govhc_ucm_base` (
...
--
-- Struttura della tabella `govhc_ucm_content`
--

CREATE TABLE `govhc_ucm_content` (
...
--
-- Struttura della tabella `govhc_updates`
--

CREATE TABLE `govhc_updates` (
...
--
-- Dump dei dati per la tabella `govhc_updates`
--

INSERT INTO `govhc_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `changelogurl`, `extra_query`) VALUES
(1, 2, 0, 'Afrikaans', '', 'pkg_af-ZA', 'package', '', 0, '5.0.2.1', '', 'https://update.joomla.org/language/details5/af-ZA_details.xml', '', '', ''),
(2, 2, 0, 'Belarusian', '', 'pkg_be-BY', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/be-BY_details.xml', '', '', ''),
(3, 2, 0, 'Bulgarian', '', 'pkg_bg-BG', 'package', '', 0, '5.3.1.2', '', 'https://update.joomla.org/language/details5/bg-BG_details.xml', '', '', ''),
(4, 2, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/ca-ES_details.xml', '', '', ''),
...
(8, 2, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '5.3.1.1', '', 'https://update.joomla.org/language/details5/cs-CZ_details.xml', '', '', ''),
(9, 2, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/da-DK_details.xml', '', '', ''),
(10, 2, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/nl-NL_details.xml', '', '', ''),
...
(16, 2, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/fi-FI_details.xml', '', '', ''),
(17, 2, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/nl-BE_details.xml', '', '', ''),
(18, 2, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/fr-FR_details.xml', '', '', ''),
(19, 2, 0, 'French, Canada', '', 'pkg_fr-CA', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/fr-CA_details.xml', '', '', ''),
(20, 2, 0, 'Georgian', '', 'pkg_ka-GE', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/ka-GE_details.xml', '', '', ''),
(21, 2, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/de-DE_details.xml', '', '', ''),
(22, 2, 0, 'German, Austria', '', 'pkg_de-AT', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/de-AT_details.xml', '', '', ''),
(23, 2, 0, 'German, Liechtenstein', '', 'pkg_de-LI', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/de-LI_details.xml', '', '', ''),
(24, 2, 0, 'German, Luxembourg', '', 'pkg_de-LU', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/de-LU_details.xml', '', '', ''),
(25, 2, 0, 'German, Switzerland', '', 'pkg_de-CH', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/de-CH_details.xml', '', '', ''),
(26, 2, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/el-GR_details.xml', '', '', ''),
(27, 2, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '5.2.4.1', '', 'https://update.joomla.org/language/details5/hu-HU_details.xml', '', '', ''),
(28, 2, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/it-IT_details.xml', '', '', ''),
(29, 2, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/ja-JP_details.xml', '', '', ''),
...
(33, 2, 0, 'Lithuanian', '', 'pkg_lt-LT', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/lt-LT_details.xml', '', '', ''),
...
(36, 2, 0, 'Persian Farsi', '', 'pkg_fa-IR', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/fa-IR_details.xml', '', '', ''),
(37, 2, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '5.2.4.1', '', 'https://update.joomla.org/language/details5/pl-PL_details.xml', '', '', ''),
(38, 2, 0, 'Portuguese, Brazil', '', 'pkg_pt-BR', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/pt-BR_details.xml', '', '', ''),
...
(41, 2, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/ru-RU_details.xml', '', '', ''),
(42, 2, 0, 'Serbian, Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/sr-RS_details.xml', '', '', ''),
(43, 2, 0, 'Serbian, Latin', '', 'pkg_sr-YU', 'package', '', 0, '5.2.3.1', '', 'https://update.joomla.org/language/details5/sr-YU_details.xml', '', '', ''),
(44, 2, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '5.2.6.1', '', 'https://update.joomla.org/language/details5/sk-SK_details.xml', '', '', ''),
(45, 2, 0, 'Slovenian', '', 'pkg_sl-SI', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/sl-SI_details.xml', '', '', ''),
(46, 2, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/es-ES_details.xml', '', '', ''),
(47, 2, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/sv-SE_details.xml', '', '', ''),
(48, 2, 0, 'Tamil, India', '', 'pkg_ta-IN', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/ta-IN_details.xml', '', '', ''),
(49, 2, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/th-TH_details.xml', '', '', ''),
(50, 2, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '5.3.0.1', '', 'https://update.joomla.org/language/details5/tr-TR_details.xml', '', '', ''),
...
(53, 2, 0, 'Welsh', '', 'pkg_cy-GB', 'package', '', 0, '5.3.0.2', '', 'https://update.joomla.org/language/details5/cy-GB_details.xml', '', '', '');

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_update_sites`
--

CREATE TABLE `govhc_update_sites` (
...
--
-- Dump dei dati per la tabella `govhc_update_sites`
--

INSERT INTO `govhc_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`, `checked_out`, `checked_out_time`) VALUES
(1, 'Joomla! Core', 'tuf', 'https://update.joomla.org/cms/', 1, 0, '', NULL, NULL),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_5.xml', 1, 1747170421, '', NULL, NULL),
(3, 'Joomla! Update Component', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 0, '', NULL, NULL);

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_update_sites_extensions`
--

CREATE TABLE `govhc_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT 0,
  `extension_id` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Dump dei dati per la tabella `govhc_update_sites_extensions`
--

INSERT INTO `govhc_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 241),
(2, 242),
(3, 24);
...
--
-- Struttura della tabella `govhc_usergroups`
--

CREATE TABLE `govhc_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Dump dei dati per la tabella `govhc_usergroups`
--

INSERT INTO `govhc_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Struttura della tabella `govhc_users`
--

CREATE TABLE `govhc_users` (
  `id` int(11) NOT NULL,
...
--
-- Dump dei dati per la tabella `govhc_users`
--

INSERT INTO `govhc_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`, `authProvider`) VALUES
(871, 'mohamed abdelhamid', 'Masti', 'mohamed08.06.2004@gmail.com', '$2y$10$6iGhhiSerNqjrMCotsWKq.W4iSuvV3V0xHveQWOVmrtJuvz9msBpi', 0, 1, '2025-05-13 21:06:57', '2025-05-13 21:08:34', '0', '', NULL, 0, '', '', 0, '');

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_user_keys`
--

CREATE TABLE `govhc_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Struttura della tabella `govhc_user_mfa`
--

CREATE TABLE `govhc_user_mfa` (
  `id` int(11) NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL,
  `title` varchar(255) NOT NULL DEFAULT '',
...
--
-- Struttura della tabella `govhc_user_notes`
--

CREATE TABLE `govhc_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `catid` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Struttura della tabella `govhc_user_profiles`
--

CREATE TABLE `govhc_user_profiles` (
...
--
-- Struttura della tabella `govhc_user_usergroup_map`
--

CREATE TABLE `govhc_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dump dei dati per la tabella `govhc_user_usergroup_map`
--

INSERT INTO `govhc_user_usergroup_map` (`user_id`, `group_id`) VALUES
(871, 8);

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_viewlevels`
--

CREATE TABLE `govhc_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT 0,
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dump dei dati per la tabella `govhc_viewlevels`
--

INSERT INTO `govhc_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Struttura della tabella `govhc_webauthn_credentials`
--

CREATE TABLE `govhc_webauthn_credentials` (
...
--
-- Struttura della tabella `govhc_workflows`
--

CREATE TABLE `govhc_workflows` (
  `id` int(11) NOT NULL,
...
--
-- Dump dei dati per la tabella `govhc_workflows`
--

INSERT INTO `govhc_workflows` (`id`, `asset_id`, `published`, `title`, `description`, `extension`, `default`, `ordering`, `created`, `created_by`, `modified`, `modified_by`, `checked_out_time`, `checked_out`) VALUES
(1, 56, 1, 'COM_WORKFLOW_BASIC_WORKFLOW', '', 'com_content.article', 1, 1, '2025-05-13 21:06:51', 871, '2025-05-13 21:06:51', 871, NULL, NULL);

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_workflow_associations`
--

CREATE TABLE `govhc_workflow_associations` (
...
--
-- Struttura della tabella `govhc_workflow_stages`
--

CREATE TABLE `govhc_workflow_stages` (
  `id` int(11) NOT NULL,
  `asset_id` int(11) DEFAULT 0,
  `ordering` int(11) NOT NULL DEFAULT 0,
...
--
-- Dump dei dati per la tabella `govhc_workflow_stages`
--

INSERT INTO `govhc_workflow_stages` (`id`, `asset_id`, `ordering`, `workflow_id`, `published`, `title`, `description`, `default`, `checked_out_time`, `checked_out`) VALUES
(1, 57, 1, 1, 1, 'COM_WORKFLOW_BASIC_STAGE', '', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Struttura della tabella `govhc_workflow_transitions`
--

CREATE TABLE `govhc_workflow_transitions` (
  `id` int(11) NOT NULL,
  `asset_id` int(11) DEFAULT 0,
  `ordering` int(11) NOT NULL DEFAULT 0,
  `workflow_id` int(11) NOT NULL,
...
--
-- Dump dei dati per la tabella `govhc_workflow_transitions`
--

INSERT INTO `govhc_workflow_transitions` (`id`, `asset_id`, `ordering`, `workflow_id`, `published`, `title`, `description`, `from_stage_id`, `to_stage_id`, `options`, `checked_out_time`, `checked_out`) VALUES
...
--
-- Indici per le tabelle `govhc_action_logs`
--
ALTER TABLE `govhc_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Indici per le tabelle `govhc_action_logs_extensions`
--
ALTER TABLE `govhc_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Indici per le tabelle `govhc_action_logs_users`
--
ALTER TABLE `govhc_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Indici per le tabelle `govhc_action_log_config`
--
ALTER TABLE `govhc_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Indici per le tabelle `govhc_assets`
--
ALTER TABLE `govhc_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indici per le tabelle `govhc_associations`
--
ALTER TABLE `govhc_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indici per le tabelle `govhc_banners`
--
ALTER TABLE `govhc_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indici per le tabelle `govhc_banner_clients`
--
ALTER TABLE `govhc_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indici per le tabelle `govhc_banner_tracks`
--
ALTER TABLE `govhc_banner_tracks`
...
--
-- Indici per le tabelle `govhc_categories`
--
ALTER TABLE `govhc_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indici per le tabelle `govhc_contact_details`
--
ALTER TABLE `govhc_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indici per le tabelle `govhc_content`
--
ALTER TABLE `govhc_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indici per le tabelle `govhc_contentitem_tag_map`
--
ALTER TABLE `govhc_contentitem_tag_map`
...
--
-- Indici per le tabelle `govhc_content_frontpage`
--
ALTER TABLE `govhc_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indici per le tabelle `govhc_content_rating`
--
ALTER TABLE `govhc_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indici per le tabelle `govhc_content_types`
--
ALTER TABLE `govhc_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indici per le tabelle `govhc_extensions`
--
ALTER TABLE `govhc_extensions`
...
--
-- Indici per le tabelle `govhc_fields`
--
ALTER TABLE `govhc_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indici per le tabelle `govhc_fields_categories`
--
ALTER TABLE `govhc_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Indici per le tabelle `govhc_fields_groups`
--
ALTER TABLE `govhc_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indici per le tabelle `govhc_fields_values`
--
ALTER TABLE `govhc_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Indici per le tabelle `govhc_finder_filters`
--
ALTER TABLE `govhc_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indici per le tabelle `govhc_finder_links`
--
ALTER TABLE `govhc_finder_links`
...
--
-- Indici per le tabelle `govhc_finder_links_terms`
--
ALTER TABLE `govhc_finder_links_terms`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indici per le tabelle `govhc_finder_logging`
--
ALTER TABLE `govhc_finder_logging`
  ADD PRIMARY KEY (`md5sum`),
  ADD KEY `searchterm` (`searchterm`(191));

--
-- Indici per le tabelle `govhc_finder_taxonomy`
--
ALTER TABLE `govhc_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_state` (`state`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_path` (`path`(100)),
...
--
-- Indici per le tabelle `govhc_finder_taxonomy_map`
--
ALTER TABLE `govhc_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indici per le tabelle `govhc_finder_terms`
--
ALTER TABLE `govhc_finder_terms`
...
--
-- Indici per le tabelle `govhc_finder_terms_common`
--
ALTER TABLE `govhc_finder_terms_common`
  ADD UNIQUE KEY `idx_term_language` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indici per le tabelle `govhc_finder_tokens`
--
ALTER TABLE `govhc_finder_tokens`
...
--
-- Indici per le tabelle `govhc_finder_tokens_aggregate`
--
ALTER TABLE `govhc_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indici per le tabelle `govhc_finder_types`
--
ALTER TABLE `govhc_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indici per le tabelle `govhc_guidedtours`
--
ALTER TABLE `govhc_guidedtours`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_state` (`published`),
  ADD KEY `idx_language` (`language`),
...
--
-- Indici per le tabelle `govhc_guidedtour_steps`
--
ALTER TABLE `govhc_guidedtour_steps`
  ADD PRIMARY KEY (`id`),
...
--
-- Indici per le tabelle `govhc_history`
--
ALTER TABLE `govhc_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indici per le tabelle `govhc_languages`
--
ALTER TABLE `govhc_languages`
...
--
-- Indici per le tabelle `govhc_mail_templates`
--
ALTER TABLE `govhc_mail_templates`
  ADD PRIMARY KEY (`template_id`,`language`);

--
-- Indici per le tabelle `govhc_menu`
--
ALTER TABLE `govhc_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indici per le tabelle `govhc_menu_types`
--
ALTER TABLE `govhc_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indici per le tabelle `govhc_messages`
--
ALTER TABLE `govhc_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indici per le tabelle `govhc_messages_cfg`
--
ALTER TABLE `govhc_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indici per le tabelle `govhc_modules`
--
ALTER TABLE `govhc_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indici per le tabelle `govhc_modules_menu`
--
ALTER TABLE `govhc_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indici per le tabelle `govhc_newsfeeds`
--
ALTER TABLE `govhc_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indici per le tabelle `govhc_overrider`
--
ALTER TABLE `govhc_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indici per le tabelle `govhc_postinstall_messages`
--
ALTER TABLE `govhc_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indici per le tabelle `govhc_privacy_consents`
--
ALTER TABLE `govhc_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Indici per le tabelle `govhc_privacy_requests`
--
ALTER TABLE `govhc_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Indici per le tabelle `govhc_redirect_links`
--
ALTER TABLE `govhc_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modified` (`modified_date`);

--
-- Indici per le tabelle `govhc_scheduler_logs`
--
ALTER TABLE `govhc_scheduler_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Indici per le tabelle `govhc_scheduler_tasks`
--
ALTER TABLE `govhc_scheduler_tasks`
  ADD PRIMARY KEY (`id`),
...
--
-- Indici per le tabelle `govhc_schemaorg`
--
ALTER TABLE `govhc_schemaorg`
  ADD PRIMARY KEY (`id`);

--
-- Indici per le tabelle `govhc_schemas`
--
ALTER TABLE `govhc_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indici per le tabelle `govhc_session`
--
ALTER TABLE `govhc_session`
...
--
-- Indici per le tabelle `govhc_tags`
--
ALTER TABLE `govhc_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indici per le tabelle `govhc_template_overrides`
--
ALTER TABLE `govhc_template_overrides`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_extension_id` (`extension_id`);

--
-- Indici per le tabelle `govhc_template_styles`
--
ALTER TABLE `govhc_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
...
--
-- Indici per le tabelle `govhc_tuf_metadata`
--
ALTER TABLE `govhc_tuf_metadata`
  ADD PRIMARY KEY (`id`);

--
-- Indici per le tabelle `govhc_ucm_base`
--
ALTER TABLE `govhc_ucm_base`
...
--
-- Indici per le tabelle `govhc_ucm_content`
--
ALTER TABLE `govhc_ucm_content`
...
--
-- Indici per le tabelle `govhc_updates`
--
ALTER TABLE `govhc_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indici per le tabelle `govhc_update_sites`
--
ALTER TABLE `govhc_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indici per le tabelle `govhc_update_sites_extensions`
--
ALTER TABLE `govhc_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indici per le tabelle `govhc_usergroups`
--
ALTER TABLE `govhc_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indici per le tabelle `govhc_users`
--
ALTER TABLE `govhc_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indici per le tabelle `govhc_user_keys`
--
ALTER TABLE `govhc_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Indici per le tabelle `govhc_user_mfa`
--
ALTER TABLE `govhc_user_mfa`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Indici per le tabelle `govhc_user_notes`
--
ALTER TABLE `govhc_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indici per le tabelle `govhc_user_profiles`
--
ALTER TABLE `govhc_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indici per le tabelle `govhc_user_usergroup_map`
--
ALTER TABLE `govhc_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indici per le tabelle `govhc_viewlevels`
--
ALTER TABLE `govhc_viewlevels`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_assetgroup_title_lookup` (`title`);

--
-- Indici per le tabelle `govhc_webauthn_credentials`
--
ALTER TABLE `govhc_webauthn_credentials`
  ADD PRIMARY KEY (`id`(100)),
  ADD KEY `user_id` (`user_id`(100));

--
-- Indici per le tabelle `govhc_workflows`
--
ALTER TABLE `govhc_workflows`
  ADD PRIMARY KEY (`id`),
...
--
-- Indici per le tabelle `govhc_workflow_associations`
--
ALTER TABLE `govhc_workflow_associations`
...
--
-- Indici per le tabelle `govhc_workflow_stages`
--
ALTER TABLE `govhc_workflow_stages`
  ADD PRIMARY KEY (`id`),
...
--
-- Indici per le tabelle `govhc_workflow_transitions`
--
ALTER TABLE `govhc_workflow_transitions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_title` (`title`(191)),
  ADD KEY `idx_asset_id` (`asset_id`),
  ADD KEY `idx_checked_out` (`checked_out`),
...
--
-- AUTO_INCREMENT per la tabella `govhc_action_logs`
--
ALTER TABLE `govhc_action_logs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT per la tabella `govhc_action_logs_extensions`
--
ALTER TABLE `govhc_action_logs_extensions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT per la tabella `govhc_action_log_config`
--
ALTER TABLE `govhc_action_log_config`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT per la tabella `govhc_assets`
--
ALTER TABLE `govhc_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=100;

--
-- AUTO_INCREMENT per la tabella `govhc_banners`
--
ALTER TABLE `govhc_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_banner_clients`
--
ALTER TABLE `govhc_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_categories`
--
ALTER TABLE `govhc_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT per la tabella `govhc_contact_details`
--
ALTER TABLE `govhc_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_content`
--
ALTER TABLE `govhc_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_content_types`
--
ALTER TABLE `govhc_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;

--
-- AUTO_INCREMENT per la tabella `govhc_extensions`
--
ALTER TABLE `govhc_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=246;

--
-- AUTO_INCREMENT per la tabella `govhc_fields`
--
ALTER TABLE `govhc_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_fields_groups`
--
ALTER TABLE `govhc_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_finder_filters`
--
ALTER TABLE `govhc_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_finder_links`
--
ALTER TABLE `govhc_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_finder_taxonomy`
--
ALTER TABLE `govhc_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT per la tabella `govhc_finder_terms`
--
ALTER TABLE `govhc_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_finder_types`
--
ALTER TABLE `govhc_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_guidedtours`
--
ALTER TABLE `govhc_guidedtours`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT per la tabella `govhc_guidedtour_steps`
--
ALTER TABLE `govhc_guidedtour_steps`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;

--
-- AUTO_INCREMENT per la tabella `govhc_history`
--
ALTER TABLE `govhc_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_languages`
--
ALTER TABLE `govhc_languages`
  MODIFY `lang_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT per la tabella `govhc_menu`
--
ALTER TABLE `govhc_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT per la tabella `govhc_menu_types`
--
ALTER TABLE `govhc_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT per la tabella `govhc_messages`
--
ALTER TABLE `govhc_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_modules`
--
ALTER TABLE `govhc_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;

--
-- AUTO_INCREMENT per la tabella `govhc_newsfeeds`
--
ALTER TABLE `govhc_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_overrider`
--
ALTER TABLE `govhc_overrider`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';

--
-- AUTO_INCREMENT per la tabella `govhc_postinstall_messages`
--
ALTER TABLE `govhc_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT per la tabella `govhc_privacy_consents`
--
ALTER TABLE `govhc_privacy_consents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_privacy_requests`
--
ALTER TABLE `govhc_privacy_requests`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_redirect_links`
--
ALTER TABLE `govhc_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_scheduler_logs`
--
ALTER TABLE `govhc_scheduler_logs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_scheduler_tasks`
--
ALTER TABLE `govhc_scheduler_tasks`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT per la tabella `govhc_schemaorg`
--
ALTER TABLE `govhc_schemaorg`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_tags`
--
ALTER TABLE `govhc_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT per la tabella `govhc_template_overrides`
--
ALTER TABLE `govhc_template_overrides`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_template_styles`
--
ALTER TABLE `govhc_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT per la tabella `govhc_tuf_metadata`
--
ALTER TABLE `govhc_tuf_metadata`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT per la tabella `govhc_ucm_content`
--
ALTER TABLE `govhc_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_updates`
--
ALTER TABLE `govhc_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

--
-- AUTO_INCREMENT per la tabella `govhc_update_sites`
--
ALTER TABLE `govhc_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT per la tabella `govhc_usergroups`
--
ALTER TABLE `govhc_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT per la tabella `govhc_users`
--
ALTER TABLE `govhc_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=872;

--
-- AUTO_INCREMENT per la tabella `govhc_user_keys`
--
ALTER TABLE `govhc_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_user_mfa`
--
ALTER TABLE `govhc_user_mfa`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_user_notes`
--
ALTER TABLE `govhc_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `govhc_viewlevels`
--
ALTER TABLE `govhc_viewlevels`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT per la tabella `govhc_workflows`
--
ALTER TABLE `govhc_workflows`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT per la tabella `govhc_workflow_stages`
--
ALTER TABLE `govhc_workflow_stages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT per la tabella `govhc_workflow_transitions`
--
ALTER TABLE `govhc_workflow_transitions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
